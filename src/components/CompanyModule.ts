...
export class CompanyModule extends pulumi.ComponentResource {
  ...
  constructor(opts: pulumi.ComponentResourceOptions = {}) {
    ...
    this.dbInstance = gcp.sql.DatabaseInstance.get(`${PREFIX}-sql-instance`, sqlInstanceName);
    ...
    this.dbUrlSecret = new gcp.secretmanager.Secret(`${PREFIX}-db-url`, {
    ...
    this.dbUrlSecretVersion = new gcp.secretmanager.SecretVersion(`${PREFIX}-db-url`, {
    ...
    this.service = new gcp.cloudrunv2.Service(`${PREFIX}-service`, {
      ...
      template: {
        ...
        volumes: [
          { name: 'cloudsql', cloudSqlInstance: { instances: [this.dbInstance.connectionName] } },
        ],
      },
    }, {
      parent: this,
