...
export class CompanyModule extends pulumi.ComponentResource {
  ...
  constructor(opts: pulumi.ComponentResourceOptions = {}) {
    super('startupsdna:index:CompanyModule', PREFIX, {}, opts);
    ...
    const serviceImage = config.get('serviceImage') || 'europe-west1-docker.pkg.dev/startupsdna-tools/admin-services/company:6f2d870';
    const dbImage = config.get('dbImage') || 'europe-west1-docker.pkg.dev/startupsdna-tools/admin-services/company-db:6f2d870';
